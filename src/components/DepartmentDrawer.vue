...
export default {
  ...
  computed: {
    ...mapState("department", ["drawer", "selectedDepartment"]),
    visible: {
      get() {
        return this.drawer;
      },
  ...
  methods: {
    ...
    ...mapMutations("department", ["setDrawer", "setSelectedDepartment"]),
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          if (this.selectedDepartment.id) {
            console.log("editing");
            newItem.id = this.selectedDepartment.id;
            HTTP()
              .put(`/departments`, newItem)
              .then(() => {
